...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox.setTitle(pyqt.fakeTranslate("Form", "Sculpt Layers", None, -1))
        self.createLayer_pushButton.setText(pyqt.fakeTranslate("Form", "Create Layer", None, -1))
        self.refresh_pushButton.setText(pyqt.fakeTranslate("Form", "Refresh", None, -1))
        self.groupBox_2.setTitle(pyqt.fakeTranslate("Form", "Sculpt Frames", None, -1))
        self.label_4.setText(pyqt.fakeTranslate("Form", "Post Hold", None, -1))
        self.label.setText(pyqt.fakeTranslate("Form", "Ease In", None, -1))
        self.label_2.setText(pyqt.fakeTranslate("Form", "Ease Out", None, -1))
        self.label_3.setText(pyqt.fakeTranslate("Form", "Pre Hold", None, -1))
        self.addFrame_pushButton.setText(pyqt.fakeTranslate("Form", "Add Sculpt Frame", None, -1))
        self.editFrame_pushButton.setText(pyqt.fakeTranslate("Form", "Edit Selected Sculpt Frame", None, -1))
        self.keyframe_checkBox.setText(pyqt.fakeTranslate("Form", "Auto Keyframe", None, -1))
